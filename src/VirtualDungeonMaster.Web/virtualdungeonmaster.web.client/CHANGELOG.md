...
- Create Angular project with ng: `ng new virtualdungeonmaster.web.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`virtualdungeonmaster.web.client.esproj`).
